"""Auto Clicker v1.1.0 - Live status window, screenshot capture, template recording"""
VERSION = "v1.1.0"
...
def open_status_window():
    ...
    log_text = tk.Text(root, height=12, width=55, font=("Monaco", 9), state="disabled")
    ...
    def update():
        ...
        try:
            ...
            for r in LIVE_STATUS.get("last_results", [])[:15]:
