"""Ev Notifier v1.1.2 - Milestone: menu bar + integrity check + recovery poll + poll log"""
...
ENCODED_KEY = None
LAST_ID_FILE = os.path.expanduser("~/.ev_last_id_v1.1.2")
...
def main():
    ...
    app = EvNotifier()
    _app_ref = app
    print(f"Ev Notifier v1.1.2 started: {REST_API_URL}")
    app.run()
